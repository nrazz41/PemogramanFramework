...
{{--main content--}}
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <div class="d-block mb-4 mb-md-0">
                ...
                <p class="mb-0">List daftar Produk.</p>
                @if (session('success'))
                ...
                <div class="table-responsive">
                    <table class="table table-centered table-nowrap mb-0 rounded">
                        <thead class="thead-light">
                            <tr>
                                <th class="border-0 rounded-start">Produk ID</th>
                            ...
                            @foreach ($dataProduk as $row)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('produk.destroy', $row->produk_id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
